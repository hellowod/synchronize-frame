...
namespace AsycServer
{
    public class AyncServer
    {
        ...
        public class MessageInfo
        {
            ...
            public MessageInfo(MessageBuffer message, IPEndPoint endPoint, AyncServer s)
            {
                server = s;
                Message = message;
                Adress = endPoint;
        ...
        private static int upByteBuffer, downByteBuffer;
        private static int upByteTotal, downByteTotal;
        ...
        private int nmbrOfClients = 0;

        private List<Client> disconnectedList = new List<Client>(), connectedList = new List<Client>();
        ...
        public AyncServer(int tcp, int udp)
        {
            tcpPort = tcp;
            udpPort = udp;
        }
